 ...
 */
public class JFrameDespedirEmpleado extends javax.swing.JFrame {

    /**
     * Creates new form JFrameAnadirAnimal
     */
    public JFrameDespedirEmpleado() {
        initComponents();
        setup();
    }
    ...
    private void jButtonDespedirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDespedirActionPerformed
        ...
        if (nombreSeleccionado == null || nombreSeleccionado.equals("No hay empleados disponibles")) {
            return;
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameDespedirEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameDespedirEmpleado().setVisible(true);
            }
        });
    }

...
public class JFrameVerVisitantes extends javax.swing.JFrame {

    /**
     * Creates new form JFrameVerEmpleados
     */
    public JFrameVerVisitantes() {
        initComponents();
        cargarEmpleados(ZooData.zoo.getVisitantes());

    }

    private void cargarEmpleados(ArrayList<Visitante> visitantes) {
        StringBuilder sb = new StringBuilder();
        for (Visitante e : visitantes) {
            sb.append("Nombre: ").append(e.getNombre()).append("\n");
            sb.append("ID: ").append(e.getId()).append("\n");
            sb.append("Fecha de nacimiento: ").append(e.getFecha()).append("\n");
            sb.append("-------------------------\n");
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Visitantes actuales");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameVerVisitantes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameVerVisitantes().setVisible(true);
            }
        });
    }

 ...
 */
public class JFrameQuitarAnimal extends javax.swing.JFrame {

    /**
     * Creates new form JFrameAnadirAnimal
     */
    public JFrameQuitarAnimal() {
        initComponents();
        setup();
    }
    ...
    public void setup() {
        ...
        if (!ZooData.zoo.getAnimales().isEmpty()) {
            ...
            jComboBoxEmployees.addItem("No hay animales disponibles");
        }
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Quitar animal del zoo");
    ...
    private void jButtonDespedirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonDespedirActionPerformed
        ...
        Animal empleadoAEliminar = null;
        for (Animal empleado : ZooData.zoo.getAnimales()) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameQuitarAnimal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFrameQuitarAnimal().setVisible(true);
            }
        });
    }
